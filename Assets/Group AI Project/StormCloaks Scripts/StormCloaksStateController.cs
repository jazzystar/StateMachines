...
public class StormCloaksStateController : MonoBehaviour {

    public GameObject navPointsParent;
    public StormCloaksState currentState;
    ...
    void Start()
    {
        ...
        SetState(new StormCloaksPatrolState(this));
    }
    ...
    public void SetState(StormCloaksState state)
    {
